...
var _reproduceYoutubeVideo = require("./modules/reproduce-youtube/reproduce-youtube-video");
var _tabsSubscription = require("./modules/tabs/tabs-subscription");
window.addEventListener('DOMContentLoaded', function () {
  (0, _iosVhFix.iosVhFix)();
  window.addEventListener('load', function () {
    (0, _reproduceYoutubeVideo.reproduceYoutubeVideo)();
    (0, _tabsSubscription.onTabClikc)();
...
},{"./modules/form-validate/form":3,"./modules/reproduce-youtube/reproduce-youtube-video":9,"./modules/tabs/tabs-subscription":10,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";
...
exports.reproduceYoutubeVideo = void 0;
var container = document.querySelector('[data-video="information-video"]');
var cover = document.querySelector('[data-video="information-video"]').querySelector('picture');
var button = document.querySelector('[data-video="information-video"]').querySelector('[data-video-button="video-button"]');
var reproduceVideo = function reproduceVideo() {
...
var reproduceYoutubeVideo = exports.reproduceYoutubeVideo = function reproduceYoutubeVideo() {
...
exports.onTabClikc = onTabClikc;
var tabsButton = document.querySelectorAll('.subscription__button');
var tabsItems = document.querySelectorAll('.subscription__price-list');
tabsButton.forEach(onTabClikc);
function onTabClikc(item) {
  item.addEventListener('click', function () {
    var currentButton = item;
    var tabId = currentButton.getAttribute('data-tab');
    var currentTab = document.querySelector(tabId);
    if (!currentButton.classList.contains('button-active')) {
      tabsButton.forEach(function (button) {
        button.classList.remove('button-active');
      });
      tabsItems.forEach(function (list) {
